...
import numpy as np
import joblit
model = joblit.load('house_model.pk1')
all_features = joblib.load('all_features.pk1')
st.title("House Prediction App")
st.write("Enter the details of the house to predict its price.")

lot_area=st.number_input("Lot Area (in square feet):",min_value=100, max_value=100, max_value=100000, value=5000)
...
total_bsmt_sf.number_number_input("Total Basement Area (in square feet):", min_value=0, value=1000)
